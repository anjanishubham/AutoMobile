...
public class Constant {
    ...
    public static final String ROOT_DATABASE="_admin_database";
    public static final String BRAND_DATABASE="_brand";
    public static final String PRODUCT_IMAGE_STORAGE="_product_image";
